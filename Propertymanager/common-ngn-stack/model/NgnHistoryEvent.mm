...
{
    [aCoder encodeDouble:self.id forKey:@"id"];
    [aCoder encodeInteger:self.mediaType forKey:@"mediaType"];
    [aCoder encodeInteger:self.start forKey:@"start"];
    [aCoder encodeInteger:self.end forKey:@"end"];
    [aCoder encodeObject:self.remotePartyDisplayName forKey:@"remotePartyDisplayName"];
    [aCoder encodeObject:self.remoteParty forKey:@"remoteParty"];
...
- (id)initWithCoder:(NSCoder *)aDecoder
{
    if (self = [super init]) {
        ...
        self.mediaType = (NgnMediaType_t)[aDecoder decodeIntegerForKey:@"mediaType"];
        self.start = [aDecoder decodeDoubleForKey:@"start"];
        self.end = [aDecoder decodeDoubleForKey:@"end"];
        self.remotePartyDisplayName = [aDecoder decodeObjectForKey:@"remotePartyDisplayName"];
        self.remoteParty = [aDecoder decodeObjectForKey:@"remoteParty"];
        self.seen = [aDecoder decodeBoolForKey:@"seen"];
        self.status = (HistoryEventStatus_t)[aDecoder decodeIntegerForKey:@"status"];
    }
    return self;
}
