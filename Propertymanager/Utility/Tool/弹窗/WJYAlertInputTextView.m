...
-(void)layoutViewPage
{
    ...
    if (!self.contentTextView) {
        ...
        self.contentTextView.layer.borderColor = MYColor(234, 234, 234).CGColor;
        self.contentTextView.font = SmallFont;
        self.contentTextView.textColor = [UIColor blackColor];
        self.contentTextView.placeholder=self.placeholderText;
        self.contentTextView.placeholderColor = [PMTools colorFromHexRGB:@"666666"];
